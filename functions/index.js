...
const paypal = require("paypal")(
  "ECmo0_o2hoUaV4RxrZOS5RNZsUGCwhWHP9rYc6EjDdr5Xz92oJBEKXgbJPCWdl_iZWsEsg6HZuA0zoAF"
);

const paypal_public_key =
  "Aeva6R87XlOOQw6F7LC4_qq2CmBgkfQSQ7Txu8ALPEz4dfZdOYpAECIH9CEwkYdNNlnxyeawZtxxWTrg";
        ...
        if (request.query.email && request.query.password) {
          admin
            ...
            .then((userRecord) => {
              ...
              response.send(getHtml("Setup done sucessfully"));
              return true;
            })
            .catch((error) => {
          ...
          response.send(`
                ...
                <body> <div class='container'> 
                        <div style="display: flex; justify-content: center; align-items:center;"><h2>Admin Setup</h2></div><br>
